    ...
    <Box sx={{ display: "flex", height: "100vh" }}>
                  ...
                  <Tooltip title={item.description} placement="right" arrow>
                    <ListItemButton
                      sx={{
                        borderRadius: '12px',
                        minHeight: 48,
                        backgroundColor: activeTab === item.id ? 'rgba(46, 125, 50, 0.15)' : 'transparent',
                        border: activeTab === item.id ? '2px solid rgba(46, 125, 50, 0.3)' : '2px solid transparent',
                        '&:hover': {
                      ...
                      <ListItem key={subItem.id} disablePadding sx={{ mb: 0.5 }}>
                        <ListItemButton
                          sx={{
                            ...
                            borderRadius: '8px',
                            minHeight: 40,
                            backgroundColor: activeTab === subItem.id ? 'rgba(46, 125, 50, 0.1)' : 'transparent',
                            '&:hover': {
                              backgroundColor: activeTab === subItem.id 
                                ? 'rgba(46, 125, 50, 0.15)' 
                                : 'rgba(46, 125, 50, 0.05)',
                        ...
                        >
                          <ListItemText
                            ...
                            primaryTypographyProps={{
                              ...
                              color: activeTab === subItem.id ? subItem.color : '#64748b',
                              fontSize: '0.85rem',
                            }}
                          />
      ...
      <Box
        ...
        sx={{
          flexGrow: 1,
          p: 4,
          background: 'linear-gradient(135deg, #f8fafc 0%, #e8f5e0 50%, #f1f8e9 100%)',
