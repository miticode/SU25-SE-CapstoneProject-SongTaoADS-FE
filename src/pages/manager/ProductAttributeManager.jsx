...
>
  <Box sx={{ 
        ...
        >
          <Box sx={{ display: 'flex', gap: 1.5, alignItems: 'center', flexWrap: 'wrap', flex: 1 }}>
            ...
            <Button
              ...
              startIcon={
                showSizesList ? <ArrowDropUpIcon /> : <ArrowDropDownIcon />
              }
              sx={{ 
                borderRadius: 1.5, 
                textTransform: 'none',
                fontWeight: 500,
                boxShadow: showSizesList ? '0 2px 5px rgba(0,0,0,0.08)' : 'none',
                bgcolor: showSizesList ? 'rgba(25, 118, 210, 0.04)' : 'transparent'
              }}
            >
              Chọn kích thước
            </Button>
    ...
    <DialogActions sx={{ p: 2.5, borderTop: '1px solid #eee', bgcolor: '#f8f9fa' }}>
      <Button 
        onClick={handleCloseDialog}
        size="large"
        sx={{ 
